...
class Weather:
    ...
    def change_these_attributes() -> dict:
        ...
        agent_description = """
Will be able to check the current weather anywhere in the world
"""
        agent_name = "WeatherChecker"
        # Model has 3 options for llm; cheap_llm, middle_ground_llm, most_intelligent_llm
        ...
        temperature = 0.1
        # Should be strings of the tool names.
        tools = ["WeatherChecker"]
